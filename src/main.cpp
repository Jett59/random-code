...
int main() {
  ...
  instructions.push_back(Instruction(Opcode::LDR, 0, 2, 0));
  instructions.push_back(Instruction(Opcode::STR, 2, 0, 12));
  instructions.push_back(Instruction(Opcode::LDR, 0, 5, 8));
